...
├── meeting_pipeline_flow1.py       # Prefect orchestration pipeline
├── parse_meetingbank.py            # Data transformation & feature engineering
├── insert_mongodb.py               # MongoDB loading script
│
├── outputs/                        # Dashboard & pipeline screenshots
